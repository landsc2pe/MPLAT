...
public class ReviewDetailActivity extends NAppCompatActivity implements I_loaddata,I_startFinish,I_dialogdata{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = getIntent();
        if(intent.hasExtra("CAMPAIGN_CODE")){ campaign_code = getIntent().getStringExtra("CAMPAIGN_CODE").toString(); }
