...
public class InfoChangeAuthActivity extends NAppCompatActivity implements I_loaddata,I_startFinish,I_dialogdata{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_change_auth);
        setTvTitle("회원정보 변경");

        common = new Common(this);

        //문구변경
        ((TextView)findViewById(R.id.infoChangeAuth_tvInfo1)).setText(Html.fromHtml("<b><font color=\"#D57A76\">이름, 생년월일, 성별은 수정이 불가능하며</font>,<br/>본인인증을 하지 않으신 분은 정보가 나타나지 않습니다.</b>"));

        etEmail = (EditText)findViewById(R.id.infoChangeAuth_etEmail);
        btnNext = (Button)findViewById(R.id.infoChangeAuth_btnNext);
        //시작시 변경완료 버튼 안보이도록 함
        btnNext.setVisibility(View.GONE);
        //변경버튼 선택시 이벤트 등록
        ((Button)findViewById(R.id.infoChangeAuth_btnChange)).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                ...
                ((Button)findViewById(R.id.infoChangeAuth_btnChange)).setVisibility(View.GONE);
        ...
        btnNext.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(regEmailCheck){
                    ...
                    Common.createDialog(InfoChangeAuthActivity.this, getString(R.string.app_name).toString(),null, "이메일 형식이 올바르지 않습니다.", getString(R.string.btn_ok),null, false, false);
                }
            }
        });
    ...
    public void dialogHandler(String result) {
        if(result.equals("ok") && dialogType == 2) {
            intent = new Intent(InfoChangeAuthActivity.this,MypageActivity.class);
    ...
    public void loadHandler(String str){
        try{
            ...
            if (err.equals("")) {
                ...
                ((EditText)findViewById(R.id.infoChangeAuth_etEmail)).setText(email);
                ((TextView)findViewById(R.id.infoChangeAuth_tvAuthYN)).setText(Html.fromHtml("<b><font color=\"#7161C4\">인증회원(인증일 "+auth_date+")</font></b>"));
                ((TextView)findViewById(R.id.infoChangeAuth_tvName)).setText(name);
                ((TextView)findViewById(R.id.infoChangeAuth_tvSex)).setText(gender);
                ((TextView)findViewById(R.id.infoChangeAuth_tvBirth)).setText(birth_date);
            }else{
