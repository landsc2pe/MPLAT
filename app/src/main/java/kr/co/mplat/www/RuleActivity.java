...
public class RuleActivity extends NAppCompatActivity implements I_loaddata,I_startFinish,I_dialogdata{
    ...
    public void loadHandler(String str){
        try{
            ...
            if (err.equals("")) {
                ...
                ((TextView)findViewById(R.id.rule_agreement)).setText(agreement1);
