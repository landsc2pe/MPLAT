...
public class QnaHistoryAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.listview_qna_history_item, parent, false);
        }
        ...
        tvQnaType.setText(listViewItem.getQnaType());
        tvTitle.setText(listViewItem.getTitle());
        tvQuestion.setText(listViewItem.getQuestion());
        tvQuestionDate.setText(listViewItem.getQuestion_date());
        tvAnswer.setText(listViewItem.getAnswer());
        tvAnswerDate.setText(listViewItem.getAnswer_date());
    ...
    public void addItem(String seq, String qnaType, String title,String question,String question_date, String answer, String answer_date, String gubun) {
        ...
        item.setQuestion_date(question_date);
        item.setAnswer(answer);
        item.setAnswer_date(answer_date);
        item.setGubun(gubun);
